...
const legalText = [
  ...
  {
    text: `PLEASE READ THE FOLLOWING TERMS OF USE CAREFULLY. BY CLICKING "I ACCEPT," REGISTERING FOR AN ACCOUNT, DOWNLOADING AN Noti-fly MOBILE APPLICATION, ACCESSING, BROWSING, OR OTHERWISE USING THE SERVICE, YOU ACKNOWLEDGE THAT YOU HAVE READ, UNDERSTOOD, AND AGREE TO BE BOUND BY THE FOLLOWING TERMS AND CONDITIONS, INCLUDING THE Noti-fly PRIVACY POLICY, ANY APPLICABLE END USER LICENSE AGREEMENT, AND ANY ADDITIONAL TERMS OR FUTURE MODIFICATIONS (COLLECTIVELY, THE "TERMS").`,
    style: 'paragraph',
    bottomMargin: true
  },
  {
